 ...
 */
public class MMediaPlayer extends SurfaceView {
    ...
    private int mPhoneHeigth;
    public MMediaPlayer(Context context,int mPhoneWidth,int mPhoneHeigth) {
        super(context);
        this.mPhoneWidth = mPhoneWidth;
        this.mPhoneHeigth = mPhoneHeigth;
        mVideoWidth = 0;
        mVideoHeight = 0;
